export const getNftData = (index: number, collection: string) => {
  ...
  if (index <= 600) {
    return { rarity: 'Legendary' as const, nickname: 'African Giant', image: `${base}/3.png`, price: 5000000, desc: 'God-tier snail.' };
  } 
  if (index <= 1350) { 
    return { rarity: 'Epic' as const, nickname: 'Strong Snail', image: `${base}/006.png`, price: 2000000, desc: 'High endurance.' };
  } 
  if (index <= 2500) { 
    return { rarity: 'Rare' as const, nickname: 'Speedy Snail', image: `${base}/20.png`, price: 1000000, desc: 'Super fast.' };
  } 
  if (index <= 4000) { 
    return { rarity: 'Uncommon' as const, nickname: 'Camouflage Snail', image: `${base}/80.png`, price: 500000, desc: 'Stealth expert.' };
  } 

  return { rarity: 'Common' as const, nickname: 'Sensory Snail', image: `${base}/1204.png`, price: 250000, desc: 'Standard shell.' }; 
};
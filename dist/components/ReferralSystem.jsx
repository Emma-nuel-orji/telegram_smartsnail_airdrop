...
const ReferralSystem = ({ initData, userId, startParam }) => {
    const [referrals, setReferrals] = (0, react_1.useState)([]);
    const [referrer, setReferrer] = (0, react_1.useState)(null);
    ...
    return (<div className="referral-container">
      <div className="ref">
        <img className="imag" src="/images/tasks/invite a telegram premium friend.png"/>
        {/* <img src={coin} width={44} height={44} /> */}
      </div>
      <div className="ref">
        <img className="imag" src="/images/tasks/invite friend.png"/>
        {/* <img src={coin} width={44} height={44} /> */}
      </div>
      <br />
      {referrer && (<div className="referral-invite-box">
      ...
      <br />
      {referrals.length > 0 && (<div className="referral-invite-box">
        <div className="referrals-list">
          <h2 className="referrals-title">Your Referrals</h2>
          <ul>
            {referrals.map((referral, index) => (<li key={index} className="referral-item">
                User {referral}
              </li>))}
          </ul>
        </div>
...
exports.default = ReferralSystem;

...
const Tasks = () => {
    ...
    const handleValidateClick = () => {
        if (validationAttempt === 0) {
            ...
            setTasks(tasks.map(task => task.id === selectedTask?.id ? { ...task, completed: true } : task));
    ...
    return (<div className="task-container" style={{ width: '100%' }}>
      <link_1.default href="/"><img src="/images/info/output-onlinepngtools (6).png" width={24} height={24} alt="Profile"/></link_1.default>

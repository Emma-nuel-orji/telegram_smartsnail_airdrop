...
function Home() {
    ...
    const [user, setUser] = (0, react_1.useState)({ points: 0 });
    const [error, setError] = (0, react_1.useState)(null);
    const [notification, setNotification] = (0, react_1.useState)('');
    const [energy, setEnergy] = (0, react_1.useState)(maxEnergy);
    const [isClicking, setIsClicking] = (0, react_1.useState)(false);
    const [showWelcomePopup, setShowWelcomePopup] = (0, react_1.useState)(false);
    const handleIncreasePoints = async (e) => {
    ...
    return (<div className="bg-gradient-main min-h-screen px-4 flex flex-col items-center text-white font-medium">
      ...
      {/* Welcome Popup */}
      {showWelcomePopup && (<div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75">
          <div className="bg-white text-black p-6 rounded-md text-center">
            ...
            <button className="mt-6 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600" onClick={handleClaim}>
              Claim
            </button>
          </div>
        </div>)}
      ...
      <div className="w-full z-10 min-h-screen flex flex-col items-center text-white">
        ...
        <div className="flex items-center justify-between w-full px-4 mb-4">
          ...
          <div className="flex space-x-4">
            <link_1.default href="/Leaderboard"><img src="/images/info/output-onlinepngtools (4).png" width={24} height={24} alt="Leaderboard"/></link_1.default>
            <link_1.default href="/wallet"><img src="/images/info/output-onlinepngtools (2).png" width={24} height={24} alt="Wallet"/></link_1.default>
            <link_1.default href="/Profile"><img src="/images/info/output-onlinepngtools (1).png" width={24} height={24} alt="Profile"/></link_1.default>
          </div>
        </div>
        ...
        <button className="glowing hover:bg-blue-600 text-white font-semibold px-3 py-1 rounded-md shadow-md mr-4
  ...
  <link_1.default href="/level">Level:</link_1.default>
    </div>
    </button>
    ...
    <span className="ml-0">Camouflage</span>
          ...
          <div className="flex-grow flex items-center max-w-60 text-sm">
            <div className="w-full bg-[#fad258] py-4 rounded-2xl flex justify-around">
              <button className="flex flex-col items-center gap-1">
                <link_1.default href="/referralsystem">
              ...
              <button className="flex flex-col items-center gap-1">
                <link_1.default href="/task">
                <img src="/images/shell.png" width={30} height={30} alt="Earn"/>
                <span>Earn</span></link_1.default>
              </button>
              <div className="h-[48px] w-[2px] bg-[#fddb6d]"></div>
              <button className="flex flex-col items-center gap-1">
                <link_1.default href="/boost">
                <img src="/images/startup.png" width={30} height={30} alt="Boosts"/>
                <span>Boost</span></link_1.default>
              </button>
            </div>
          </div>
      ...
      <div className="flex-grow flex items-center justify-center">
        ...
        <div className="relative mt-4" onClick={handleIncreasePoints}>
          ...
          {clicks.map((click) => (<div key={click.id} className="absolute text-5xl font-bold text-white opacity-0" style={{
                top: `${click.y - 42}px`,
                left: `${click.x - 28}px`,
      ...
      {notification && (<div className="mt-4 p-2 bg-green-100 text-green-700 rounded">
          {notification}
        </div>)}
    </div>);
}

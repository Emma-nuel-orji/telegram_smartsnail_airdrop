    ...
    try {
      const res = await fetch('/api/increase-points', {
        ...
        body: JSON.stringify({
          ...
          currentPoints: newPoints, // Send current points for verification
        }),
      });
      ...
      if (data.success) {
        // Update if server returns different value
        ...
        // Revert to previous state if server rejects
        const revertUser = {
          ...user,
          points: prevPoints,
        };
      ...
      // On network error, keep local changes but flag for retry

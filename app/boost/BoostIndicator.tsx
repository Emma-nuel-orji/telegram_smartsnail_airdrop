...
const BoostIndicator = ({ user }: BoostIndicatorProps) => {
  ...
  return (
    <div className="fixed top-22 left-4 right-4 z-[50] bg-black/20 backdrop-blur-md rounded-full overflow-hidden py-1.4 border border-white/5 pointer-events-none">
      <motion.div 

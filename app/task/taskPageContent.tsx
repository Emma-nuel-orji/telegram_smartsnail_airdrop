...
const TaskPageContent: React.FC = () => {
  const [tasks, setTasks] = useState<Task[]>([
    ...
    { id: 22, description: 'Daily Task 3', completed: false, reward: 5000, section: 'daily', type: 'daily', image: '/images/daily/join twitter everyday.png', link: 'https://socialmedia.com/profile1', batchId: 'batch_2024_001', completedTime: null },
